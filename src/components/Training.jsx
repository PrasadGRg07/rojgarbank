    ...
    <div className="relative bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="relative max-w-5xl mx-auto px-4 pt-24 pb-16 text-center">
        ...
        <p className="mt-8 max-w-3xl mx-auto text-slate-600 leading-relaxed">
          At RogjarBank, we offer a wide selection of professional training
          ...
          the way. Your desire to learn, combined with our commitment to quality
          education, creates the perfect path to career success.
        </p>
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
          {loading ? (
            ...
            trainings.map((course, i) => {
              ...
              const duration = course.start_time
        ...
        <div className="bg-white py-20 px-4">
          <div className="max-w-5xl mx-auto text-center mb-14">
            ...
            <p className="mt-3 max-w-2xl mx-auto text-slate-500">
              Join hundreds of professionals across Nepal who have advanced
              their careers through our training programs.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="grid grid-cols-2 gap-4">
                {stats.map(({ label, value, Icon }, i) => (
                  ...
                  >
                    <Icon
                      size={22}
                      className="mx-auto text-sky-600 transition-transform duration-300 group-hover:scale-110"
                      strokeWidth={1.75}
                    />
            ...
            <div className="relative rounded-2xl bg-gradient-to-br from-sky-600 via-sky-600 to-cyan-500 text-white p-8 overflow-hidden">
              ...
              <p className="mt-4 text-sm text-white/90 leading-relaxed">
                Enroll in any of our industry-leading courses and gain the
                skills employers are looking for. Real projects, real mentors,
                real results.
              </p>
              ...
              <div className="mt-8 flex items-center gap-2 text-xs text-white/80">
                ...
                Click "Enroll Now" on any course in the gallery above to get
                started
              </div>
            </div>
          </div>
      ...
      <div className="bg-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <p className="mt-3 text-slate-500">
            Discover what makes our training programs stand out and how we help
      ...
      {selectedCourse && (
        ...
        >
          ...
          >
            <div
              className={`relative h-40 ${selectedCourse.iconBg} flex items-center justify-center rounded-t-2xl overflow-hidden`}
            >
              <img
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  {enrollCourse.title} · {enrollCourse.price}
                </p>
              </div>
              <button
                onClick={() => setEnrollCourse(null)}
            ...
            {enrollSubmitted ? (
              <div className="mt-6 flex flex-col items-center text-center gap-3 py-6">
                ...
                <p className="text-sm text-slate-500">
                  We've received your details for {enrollCourse.title}. Our team
                  will reach out to confirm your seat shortly.
                </p>
                <button
                  onClick={() => setEnrollCourse(null)}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEnrollForm({
                        ...enrollForm,
                        courseOfInterest: e.target.value,
                      })
                    }
                  ...
                  >
                    ...
                    {trainings.map((c, i) => (
                      <option key={i} value={c.title || c.course_name}>
