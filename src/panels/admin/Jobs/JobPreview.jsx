      ...
      <div className="border-b bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">Job Preview (Admin)</h1>
      ...
      <div className="mx-auto mt-8 max-w-7xl px-6">
          ...
          <div className="flex flex-col justify-between gap-6 lg:flex-row">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-slate-600">
                {job.shortDescription || "Short description will appear here."}
              </p>
            </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-xl bg-white p-5 shadow-sm">
            ...
            <h3 className="mt-2 font-semibold">{job.openings}</h3>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-8 lg:col-span-2">
            ...
            {/* Skills */}
            <div className="rounded-2xl bg-white p-8 shadow-sm">
              <h2 className="mb-6 text-2xl font-bold">Required Skills</h2>
            ...
            {/* Benefits */}
            <div className="rounded-2xl bg-white p-8 shadow-sm">
              <h2 className="mb-6 text-2xl font-bold">Benefits & Perks</h2>
              <div className="flex flex-wrap gap-3">
                {job.benefits?.length ? (
          ...
          <div className="space-y-6">
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <h2 className="mb-5 text-xl font-bold">Job Overview</h2>
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="font-semibold">{job.workMode || "-"}</p>
                </div>
                <div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">{job.contactPhone || "-"}</p>
                </div>
                <div>
        ...
        <div className="mt-10 mb-10 rounded-2xl bg-white p-6 shadow-sm">
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              <h2 className="text-xl font-bold">Ready to publish this job?</h2>
              <p className="mt-1 text-slate-500">
                Review all information before making this job visible to
                applicants.
              </p>
            </div>
