...
export default function EditTraining() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateTraining(id, submitData);

      navigate(`/admin/dashboard/training/${id}`);
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title="Edit Training"
        subtitle="Update training session"
      />
      ...
      >
        ...
        <div>
          ...
          {currentImage && (
            <div className="mb-3">
              <img src={currentImage} alt="Current training" className="h-24 w-40 object-cover rounded" />
