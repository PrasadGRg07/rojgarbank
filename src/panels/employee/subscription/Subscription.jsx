...
const PLANS = [
  {
    ...
    features: ["1 Active Job", "Company Profile", "View Applicants", "Basic Dashboard", "Email Notifications"],
    color: "slate",
  },
  {
    name: "basic",
    ...
    features: ["5 Active Jobs", "300 Applicants", "Applicant Tracking", "Shortlist Candidates", "Analytics Dashboard", "Priority Email Support"],
    color: "blue",
    popular: false,
  },
  {
    ...
    features: ["Unlimited Jobs", "Unlimited Applicants", "Resume Search", "Featured Job Posts", "Advanced ATS", "Verified Company Badge", "Team Members", "Hiring Reports"],
    color: "indigo",
    popular: true,
  },
  {
    ...
    features: ["Unlimited Everything", "Dedicated Account Manager", "API Access", "Custom Branding", "Multiple Recruiters", "24/7 Priority Support"],
    color: "purple",
  },
];
